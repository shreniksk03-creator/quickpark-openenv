...
class QuickParkEnv:
    ...
    def step(self, action: QuickParkAction):
        # Ultra-safe bounds to prevent float rounding logic from registering as 0.0 or 1.0
        reward_score = 0.15
        is_done = True 
        ...
        if not ticket:
            return self.current_state, QuickParkReward(score=0.15, is_done=True, info="No active ticket."), True, {"info": "No active ticket"}
